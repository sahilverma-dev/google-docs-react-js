...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white shadow-md w-100 flex items-center py-2 px-3">
            <Button
                color="gray"
                buttonType="outline"
                rounded={true}
      ...
      "
            >
                ...
                <input
                    type="text"
                    placeholder="Search..."
                    className=" text-gray-600 bg-transparent outline-none px-5 border-0 flex-grow text-base"
                />
            </div>
            <Button
                color="gray"
                ...
                rounded={true}
                ripple="dark"
                className="ml-0 h-10 w-10 border-0"
            >
